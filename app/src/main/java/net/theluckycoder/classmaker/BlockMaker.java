...
public final class BlockMaker extends AppCompatActivity {
    ...
    public void createClass(View view) {
        ...
        String sourceFileString = String.valueOf("#include \"" + classNameTxt + ".h\"\n\n" +
                classNameTxt + "::" + classNameTxt + "(short id) : Block(\"" + descriptionIdTxt + "\", " + "id, Material::getMaterial(MaterialType::" + materialTxt + ")) {\n" +
                "\tmBlocks[id] = this;\n" +
